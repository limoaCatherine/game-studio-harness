...
GSH 用四层文件合同承接**完整游戏制作流水线**。代理在点名集合内按步执行、写入隔离面；人闸负责支柱、范围、晋升与发版。设计主张是有界自主、可审计 diff、人闸收口——不是无人值守发版。

先读仓库根 [README.md](../../README.md) 的「设计哲学」，再读「你需要先了解的三件事」（全流程覆盖 / 人机边界 / 能力曲线），再下钻本目录。English twin：[README.en.md](README.en.md)。
